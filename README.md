...
| `POST`   | `/user`                | Cadastar usuário                     | ❌ Não          |
| `PUT`    | `/user/:id`            | Atualizar usuário                    | ✔️ Sim          |
| `DELETE` | `/user/:id`            | Deletar usuário                      | ✔️ Sim          |
| `GET`    | `/category/search`     | Listar categoria com filtros         | ❌ Não          |
| `GET`    | `/category/slug/:slug` | Consultar categoria por slug         | ❌ Não          |
| `GET`    | `/category/:id`        | Consultar categoria por ID           | ❌ Não          |
| `POST`   | `/category`            | Cadastrar categoria                  | ✔️ Sim          |
| `PUT`    | `/category/:id`        | Atualizar categoria                  | ✔️ Sim          |
...
| `POST`   | `/product`             | Cadastrar produto                    | ✔️ Sim          |
